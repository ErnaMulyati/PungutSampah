...
/**
 * Write a description of class Kertaskusut here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Kertaskusut extends Sampah
{
    /**
     * Act - do whatever the Kertaskusut wants to do. This method is called whenever
    ...
    public void act() 
    {
        ...
        if(Greenfoot.mouseDragEnded(this)){
            if(getOneIntersectingObject(SampahKertas.class) !=null){
                ...
                getWorld().addObject(new Lembarankertas(),0, 197);
                getWorld().removeObject(this);
            }
